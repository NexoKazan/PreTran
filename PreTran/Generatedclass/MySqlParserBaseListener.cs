...
public partial class MySqlParserBaseListener : IMySqlParserListener {
	...
	/// <summary>
	/// Enter a parse tree produced by the <c>alterByAnalyzePartitiion</c>
	/// labeled alternative in <see cref="MySqlParser.alterSpecification"/>.
	/// <para>The default implementation does nothing.</para>
	/// </summary>
	/// <param name="context">The parse tree.</param>
	public virtual void EnterAlterByAnalyzePartitiion([NotNull] MySqlParser.AlterByAnalyzePartitiionContext context) { }
	/// <summary>
	/// Exit a parse tree produced by the <c>alterByAnalyzePartitiion</c>
	/// labeled alternative in <see cref="MySqlParser.alterSpecification"/>.
	/// <para>The default implementation does nothing.</para>
	/// </summary>
	/// <param name="context">The parse tree.</param>
	public virtual void ExitAlterByAnalyzePartitiion([NotNull] MySqlParser.AlterByAnalyzePartitiionContext context) { }
	/// <summary>
