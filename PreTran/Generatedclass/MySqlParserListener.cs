...
public interface IMySqlParserListener : IParseTreeListener {
	...
	/// </summary>
	/// <param name="context">The parse tree.</param>
	void EnterAlterByAnalyzePartitiion([NotNull] MySqlParser.AlterByAnalyzePartitiionContext context);
	/// <summary>
	/// Exit a parse tree produced by the <c>alterByAnalyzePartitiion</c>
	/// labeled alternative in <see cref="MySqlParser.alterSpecification"/>.
	/// </summary>
	/// <param name="context">The parse tree.</param>
	void ExitAlterByAnalyzePartitiion([NotNull] MySqlParser.AlterByAnalyzePartitiionContext context);
	/// <summary>
