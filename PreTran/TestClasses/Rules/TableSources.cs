...
namespace PreTran.TestClasses.Rules
{
    ...
    {
        TableSourcesListener _listener = new TableSourcesListener();
        public TableSources(Interval ruleInterval, ParserRuleContext context, string text) : base(ruleInterval, context, text)
        {
