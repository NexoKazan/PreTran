...
namespace ClusterixN.Manager.Managers
{
    ...
    /// </summary>
    internal class QuerySourceManager : QuerySourceManagerBase
    {
        #region Queries
                ...
                builder.CreateRelation(selectPS2, "PS2",
                    builder.CreateRelationSchema(
                        ...
                        new List<Index>()
                        {
                            ...
                            new Index(true) {Name = "primary", FieldNames = new List<string>() { "PS_PARTKEY" , "PS_SUPPKEY" } },
                        })
                        )));
...
FROM
            ...
            var join15 = builder.AddJoinQuery(builder.CreateJoinQuery(@"SELECT
	S_ADDRESS,
	S_PHONE,
	S_COMMENT,
	S_ACCTBAL,
	...
	N_NAME
FROM
                                    " + Constants.LeftRelationNameTag + @" AS J14,
                                    " + Constants.RightRelationNameTag + @" AS J03
                        WHERE
                        J14.PS_SUPPLYCOST = J03.PS_SUPPLYCOST AND P_PARTKEY = J03.PS_PARTKEY",
                builder.CreateRelationSchema(
                    new List<Field>()
                    {
                        new Field() {Name = "S_ADDRESS", Params = " VARCHAR(40) NOT NULL"},
...
FROM
	...
	S_COMMENT
FROM
	" + Constants.RelationNameTag + @" AS J15
ORDER BY
	S_ACCTBAL DESC,
	N_NAME,
	S_NAME,
...
FROM
	" + Constants.RelationNameTag + @";",
                builder.CreateRelation(join15, QueryRelationStatus.Wait)));
