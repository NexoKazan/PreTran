...
{
    internal class JoinStartSequencedMultiNodeWait : HandlerBase
    {
        ...
        public JoinStartSequencedMultiNodeWait(IServerCommunicator server, IQueryManager queryManager, QueryBufferManager queryBufferManager,
        ...
        {
            var selectNodes = NodesManager.GetNodes(NodeType.Io);

            if(selectNodes.All(n=>n.CanSendQuery) && selectNodes.All(n=>n.QueryInProgress == 0))
